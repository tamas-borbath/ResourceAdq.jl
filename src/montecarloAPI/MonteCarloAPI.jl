...
struct MonteCarloAPI <: SimulationSpec
...
function assess(
    system::SystemModel{N}, method::MonteCarloAPI,
    sampleseeds::Channel{Int},
    results::Channel{<:Tuple{Vararg{ResultAccumulator{MonteCarloAPI}}}},
    resultspecs::ResultSpec...
