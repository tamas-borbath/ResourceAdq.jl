...
for i_type in [:NTC]#[:Copperplate,:QCopperplate,:Nodal,:NTC,:QNTC,:Autarky]
    ...
    println("    1: "*string(EUE(x[1],"Area_1")))
    println("    2: "*string(EUE(x[1],"Area_2")))
    println("    3: "*string(EUE(x[1],"Area_3")))
    println("Total: "*string(EUE(x[1])))
    println(" ")

    println("    1: "*string(LOLE(x[1],"Area_1")))
    println("    2: "*string(LOLE(x[1],"Area_2")))
    println("    3: "*string(LOLE(x[1],"Area_3")))
